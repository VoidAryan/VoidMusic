...
from DzL.utils import (Dzbin, get_channeplayCB,
                              seconds_to_min)
from DzL.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from DzL.utils.decorators.language import language, languageCB
from DzL.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://telegra.ph/file/35f88f4ec6b281516b324.jpg",
        caption=_["queue_1"],
    )
