...
from DzL import app
from DzL.misc import HAPP, SUDOERS, XCB
        ...
        try:
            ...
            for x in served_chats:
                try:
                    ...
                    pass
            await response.edit(
                f"{nrs.text}\n\nBot was updated successfully! Now, wait for 2 - 3 mins until the bot restarts!"
            )
            os.system(
